...
class EA:
	...
	self.NUMBER_GENERATION = int(math.sqrt(budget))
        ...
        # print("EA: POPULATION_SIZE = " + str(POPULATION_SIZE))
    ...
    def select_pop(self, population, fitness_population):
        ...
        return [ individual for individual, fitness in sorted_population[:int(self.POPULATION_SIZE * self.TRUNCATION_RATE)] ]
